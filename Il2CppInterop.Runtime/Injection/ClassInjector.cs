...
namespace Il2CppInterop.Runtime.Injection
{
    ...
    public unsafe static class ClassInjector
    {
        ...
        private static bool IsMethodEligible(MethodInfo method)
        {
            ...
            {
                Logger.Warning($"Method {method} on type {method.DeclaringType} has unsupported return type {method.ReturnType}");
                return false;
            }
            ...
            foreach (var parameter in method.GetParameters())
            {
                ...
                {
                    Logger.Warning($"Method {method} on type {method.DeclaringType} has unsupported parameter {parameter} of type {parameterType}");
                    return false;
                }
            }
